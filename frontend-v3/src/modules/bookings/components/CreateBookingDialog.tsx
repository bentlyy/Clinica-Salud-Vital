...
const bookingSchema = z.object({
  doctor_id: z.number({ required_error: 'Selecciona un doctor' }).min(1, 'Selecciona un doctor'),
      ...
      <Box component="form" onSubmit={handleSubmit(handleFormSubmit)}>
        <DialogContent sx={{ pt: 2 }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
            ...
            {!isAuthenticated && (
              <>
                <Typography variant="subtitle2" sx={{ color: '#374151', mt: 1 }}>
        ...
        <DialogActions sx={{ px: 3, pb: 3, pt: 1 }}>
          ...
          >
            {isSubmitting ? <CircularProgress size={20} color="inherit" /> : 'Agendar Cita'}
          </Button>
        </DialogActions>
      </Box>
    </Dialog>
