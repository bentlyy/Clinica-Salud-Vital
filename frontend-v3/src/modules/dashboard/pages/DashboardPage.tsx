import { Box, Typography, Paper, Grid, Avatar, Chip, List, ListItem, ListItemAvatar, ListItemText, Divider } from '@mui/material';
...
import { useDashboardStats, useUpcomingBookings } from '../hooks/useAnalytics';
