...
export function BloodTestIcon({ size = SIZE, color }: LabIconProps) {
  return (
...
export function GlucoseIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function LipidIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function KidneyIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function ThyroidIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function UrineIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function HbA1cIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function InflammationIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function LiverIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
export function LabIcon({ size = SIZE, color }: LabIconProps) {
  return (
    <svg {...iconProps} width={size} height={size} color={color}>
...
const ICON_MAP: Record<string, (props: LabIconProps) => JSX.Element> = {
...
export function getLabIcon(name: string): (props: LabIconProps) => JSX.Element {
