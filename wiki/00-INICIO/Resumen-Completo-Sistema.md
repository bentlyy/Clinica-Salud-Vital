...
| `mercadopago.service.ts` | Cliente Mercado Pago CLP (preferencias Checkout Pro + fetchPayment); stub si no hay `MERCADOPAGO_ACCESS_TOKEN` |
...
- Health check `/health` (DB, pool, mercadopago)
