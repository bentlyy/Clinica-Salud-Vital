...
export const getPrescriptionsByClinicalRecord = async (clinical_record_id) => {
...
export const createPrescription = async (data, doctor_id) => {
...
export const updatePrescription = async (id, data, doctor_id) => {
  const result = await pool.query(`
...
export const deletePrescription = async (id, doctor_id) => {
  const result = await pool.query(`
