...
export const searchCie10 = async ({ query, category, limit = 50, offset = 0 } = {}) => {
...
export const getCie10ByCode = async (code) => {
...
export const createCie10Entry = async ({ code, description, category }) => {
...
export const updateCie10Entry = async (id, { description, category }) => {
  const result = await pool.query(
...
export const deleteCie10Entry = async (id) => {
