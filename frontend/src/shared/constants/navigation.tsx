...
const NAV_ITEMS_DEF: NavItemDef[] = [
  ...
  { labelKey: 'patients', icon: <PersonSearch />, path: '/patients', roles: ['superadmin', 'admin', 'doctor'] },
  { labelKey: 'specialties', icon: <MedicalServices />, path: '/specialties', roles: ['superadmin', 'admin'] },
  { labelKey: 'bookings', icon: <CalendarMonth />, path: '/bookings', roles: ['superadmin', 'admin', 'doctor', 'patient'] },
  { labelKey: 'availability', icon: <CalendarMonth />, path: '/availability', roles: ['doctor'] },
  { labelKey: 'clinicalRecords', icon: <Description />, path: '/clinical-records', roles: ['superadmin', 'admin', 'doctor', 'patient'] },
  { labelKey: 'prescriptions', icon: <Assignment />, path: '/prescriptions', roles: ['superadmin', 'admin', 'doctor', 'patient'] },
  { labelKey: 'medicalHistory', icon: <History />, path: '/medical-history', roles: ['superadmin', 'admin', 'doctor', 'patient'] },
  {
    labelKey: 'laboratory',
    icon: <Science />,
    path: '/laboratory',
    roles: ['superadmin', 'admin', 'doctor', 'lab_technician'],
  ...
  { labelKey: 'billing', icon: <Receipt />, path: '/billing', roles: ['superadmin', 'admin'] },
  { labelKey: 'analytics', icon: <Assessment />, path: '/analytics', roles: ['superadmin', 'admin', 'doctor'] },
  { labelKey: 'reports', icon: <Badge />, path: '/reports', roles: ['superadmin', 'admin', 'doctor', 'lab_technician'] },
