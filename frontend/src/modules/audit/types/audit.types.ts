...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  security_delete: 'Eliminación de Seguridad',
  phi_create: 'Registro de Ficha',
  phi_update: 'Actualización de Ficha',
  phi_delete: 'Eliminación de Ficha',
  create_booking: 'Creación de Cita',
  cancel_booking: 'Cancelación de Cita',
  create_clinical_record: 'Creación de Expediente',
  ...
  'clinical_record.created': 'Expediente Creado',
  'clinical_record.updated': 'Expediente Actualizado',
  'invoice.created': 'Factura Creada',
  'invoice.paid': 'Factura Pagada',
  'lab_request.created': 'Solicitud Lab Creada',
  'lab_request.completed': 'Solicitud Lab Completada',
  'patient.created': 'Paciente Creado',
  'doctor.updated': 'Doctor Actualizado',
