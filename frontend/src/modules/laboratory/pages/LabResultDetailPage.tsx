          ...
          <Table>
            ...
            <TableBody>
              {items.map((item, idx) => {
                ...
                return (
                  <TableRow key={item.id} hover sx={{ backgroundColor: idx % 2 !== 0 ? theme.palette.custom.surface.muted : 'transparent' }}>
                    <TableCell>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Box sx={{
                          width: 8, height: 8, borderRadius: '50%',
                          backgroundColor: hasResult ? theme.palette.success.main : theme.palette.warning.main, flexShrink: 0,
                        }} />
                    ...
                    <TableCell>
                      {hasResult ? (
                        <Typography variant="body2" sx={{ fontWeight: 600, color: theme.palette.custom.status.success.text }}>
                          {item.result_value}
                    ...
                    <TableCell>
                      <Typography variant="body2" sx={{ color: theme.palette.text.secondary, fontSize: 13 }}>{item.reference_range || '—'}</Typography>
                    </TableCell>
                    <TableCell>
