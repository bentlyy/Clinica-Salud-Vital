...
export default function ConfirmPage() {
  ...
  const iconMap: Record<PageStatus, JSX.Element> = {
    loading: <CircularProgress size={64} sx={{ color: theme.palette.primary.main }} />,
    success: <CheckCircleIcon sx={{ fontSize: 64, color: theme.palette.success.main }} />,
    error: <ErrorIcon sx={{ fontSize: 64, color: theme.palette.error.main }} />,
    info: <InfoIcon sx={{ fontSize: 64, color: theme.palette.warning.main }} />,
  };
